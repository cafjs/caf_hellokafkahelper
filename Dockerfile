...
# AUTHOR:         
# DESCRIPTION:    Cloud Assistants application hellokafkahelper
# TO_BUILD:        cafjs mkImage . gcr.io/cafjs-k8/<user>-hellokafkahelper
# TO_RUN:         cafjs run --appImage gcr.io/cafjs-k8/<user>-hellokafkahelper hellokafkahelper
